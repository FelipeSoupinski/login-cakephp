...
/* C:\xampp\htdocs\vendor\cakephp\bake\src\Template\Bake\\Template\view.twig */
class __TwigTemplate_6a94c25bc013f4d52f42b586e23892315c0592b083e7be1ce6685e3cfabb2ce0 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa->enter($__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig"));
...
";
    ...
    <ul class=\"side-nav\">
        ...
        echo "]) ?> </li>
        <li><?= \$this->Form->postLink(__('Excluir ";
        // line 31
        echo twig_escape_filter($this->env, ($context["singularHumanName"] ?? null), "html", null, true);
        echo "'), ['action' => 'delete', ";
        echo ($context["pK"] ?? null);
        echo "], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', ";
        echo ($context["pK"] ?? null);
        echo ")]) ?> </li>
        <li><?= \$this->Html->link(__('Listar ";
        // line 32
...
";
            ...
            $context = array_intersect_key($context, $_parent) + $_parent;
            // line 118
            echo "                <th scope=\"col\" class=\"actions\"><?= __('Ações') ?></th>
            </tr>
            <?php foreach (\$";
            // line 120
            echo twig_escape_filter($this->env, ($context["singularVar"] ?? null), "html", null, true);
...
";
            ...
            echo "                <td class=\"actions\">
                    <?= \$this->Html->link(__('Ver'), ['controller' => '";
            // line 127
            echo twig_escape_filter($this->env, $this->getAttribute($context["details"], "controller", []), "html", null, true);
            echo "', 'action' => 'view', ";
            echo ($context["otherPk"] ?? null);
            echo "]) ?>
                    <?= \$this->Html->link(__('Editar'), ['controller' => '";
            // line 128
            echo twig_escape_filter($this->env, $this->getAttribute($context["details"], "controller", []), "html", null, true);
            echo "', 'action' => 'edit', ";
            echo ($context["otherPk"] ?? null);
            echo "]) ?>
                    <?= \$this->Form->postLink(__('Deletar'), ['controller' => '";
            // line 129
            echo twig_escape_filter($this->env, $this->getAttribute($context["details"], "controller", []), "html", null, true);
            echo "', 'action' => 'delete', ";
            echo ($context["otherPk"] ?? null);
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig";
    }
...
<nav class=\"large-3 medium-4 columns\" id=\"actions-sidebar\">
    <ul class=\"side-nav\">
        ...
        <li><?= \$this->Form->postLink(__('Excluir {{ singularHumanName }}'), ['action' => 'delete', {{ pK|raw }}], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', {{ pK|raw }})]) ?> </li>
...
{% set otherPluralHumanName = details.controller|underscore|humanize %}
    <div class=\"related\">
        <h4><?= __('Relacionado {{ otherPluralHumanName }}') ?></h4>
...
{% set otherPk = '\$' ~ otherSingularVar ~ '->' ~ details.primaryKey[0] %}
                <td class=\"actions\">
                    <?= \$this->Html->link(__('Ver'), ['controller' => '{{ details.controller }}', 'action' => 'view', {{ otherPk|raw }}]) ?>
                    <?= \$this->Html->link(__('Editar'), ['controller' => '{{ details.controller }}', 'action' => 'edit', {{ otherPk|raw }}]) ?>
                    <?= \$this->Form->postLink(__('Deletar'), ['controller' => '{{ details.controller }}', 'action' => 'delete', {{ otherPk|raw }}], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', {{ otherPk|raw }})]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
...
", "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig", "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig");
    }
}
