...
/* C:\xampp\htdocs\vendor\cakephp\bake\src\Template\Bake\\Template\index.twig */
class __TwigTemplate_0be6c690f465f9554da4ecdf318876932cbe817f3f3f70bfcc3ae24d6261a870 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa->enter($__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\index.twig"));
...
";
        ...
        echo "                <td class=\"actions\">
                    <?= \$this->Html->link(__('Ver'), ['action' => 'view', ";
        // line 72
        ...
        echo ($context["pk"] ?? null);
        echo "]) ?>
                    <?= \$this->Form->postLink(__('Excluir'), ['action' => 'delete', ";
        // line 74
        echo ($context["pk"] ?? null);
    ...
    <div class=\"paginator\">
        ...
        <p><?= \$this->Paginator->counter(['format' => __('Página ";
        // line 88
        echo "{{";
        echo "page";
        echo "}}";
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\index.twig";
    }
...
{% set pk = '\$' ~ singularVar ~ '->' ~ primaryKey[0] %}
                <td class=\"actions\">
                    <?= \$this->Html->link(__('Ver'), ['action' => 'view', {{ pk|raw }}]) ?>
                    <?= \$this->Html->link(__('Editar'), ['action' => 'edit', {{ pk|raw }}]) ?>
                    <?= \$this->Form->postLink(__('Excluir'), ['action' => 'delete', {{ pk|raw }}], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', {{ pk|raw }})]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <div class=\"paginator\">
        ...
        <p><?= \$this->Paginator->counter(['format' => __('Página {{ '{{' }}page{{ '}}' }} de {{ '{{' }}pages{{ '}}' }}, mostrando {{ '{{' }}current{{ '}}' }} registros de {{ '{{' }}count{{ '}}' }} totais')]) ?></p>
    </div>
</div>
", "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\index.twig", "C:\\xampp\\htdocs\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\index.twig");
    }
}
