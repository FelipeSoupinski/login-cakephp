...
class Validator implements ArrayAccess, IteratorAggregate, Countable
{
    ...
    public function getRequiredMessage($field)
    {
        ...
        if ($this->_useI18n) {
            $defaultMessage = __d('cake', 'Este campo é obrigatório');
        }
    ...
    public function getNotEmptyMessage($field)
    {
        ...
        $defaultMessage = 'Este campo não pode ser deixado em branco';
        if ($this->_useI18n) {
            $defaultMessage = __d('cake', 'Este campo não pode ser deixado em branco');
        }
    ...
    protected function _processRules($field, ValidationSet $rules, $data, $newRecord)
    {
        ...
        if ($this->_useI18n) {
            $message = __d('cake', 'O valor fornecido é inválido');
        }
